...
class TriPlaneFeatureGenerator(torch.nn.Module):
    def __init__(self,
    ...
    def synthesis(self, planes, c, ws=None, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
