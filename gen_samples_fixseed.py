# -*- coding:utf-8 -*-
###################################################################
###   @FilePath: \eg3d\gen_samples_fixseed.py
###   @Author: AceSix
###   @Date: 2022-11-13 13:15:43
###   @LastEditors: AceSix
###   @LastEditTime: 2022-11-13 13:33:41
...
@click.option('--seeds', type=int, help='List of random seeds (e.g., \'0,1,4-6\')', required=True)
...
def generate_images(
    ...
    np.random.RandomState(seeds)
    # Generate images.
    for seed_idx, seed in enumerate(range(3)):
