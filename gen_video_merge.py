...
from camera_utils import LookAtPoseSampler, LookAtPoseSamplerRef
        ...
        for yi in range(grid_h):
            for xi in range(grid_w):
                if "car" in mp4:
                    ...
                    cam2world_pose = LookAtPoseSampler.sample(0 + yaw_range * np.sin(2 * 3.14 * frame_idx / (num_keyframes * w_frames)),
